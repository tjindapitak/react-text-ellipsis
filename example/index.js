  ...
  render() {
    return (
      <div>
        ...
        <hr/>
        <h3>2 wide lines clamping (useJsOnly)</h3>
        <div style={{width: '500px', height: '40px', border: '1px dashed', backgroundColor: '#f1f1f1'}}>
          <TextEllipsis lines={2} useJsOnly={true}>{this.text}</TextEllipsis>
        </div>
        <hr/>
        ...
        <hr/>
        <h3>Container to fit whole text</h3>
        <div style={{width: '500px', height: '200px', border: '1px dashed', backgroundColor: '#f1f1f1'}}>
          <TextEllipsis lines={10} useJsOnly={true}>{this.text}</TextEllipsis>
        </div>
      </div>
    );
  }
